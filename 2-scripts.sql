...
COPY MAQUINAS
FROM '/home/igoml/Documents/CURSO UDEMY - SQL E BANCO DE DADOS PARA DATA SCIENCE/LogMaquinas.csv' 
DELIMITER ','
CSV HEADER;
...
/* Analisando o resultado da mediana com novos valores */
...
'/home/igoml/Documents/CURSO UDEMY - SQL E BANCO DE DADOS PARA DATA SCIENCE/REL_LOCADORA.csv'
DELIMITER ';'
CSV HEADER;
...
'/home/igoml/Documents/CURSO UDEMY - SQL E BANCO DE DADOS PARA DATA SCIENCE/RELATORIO_LOCADORA.csv'
DELIMITER ';'
CSV HEADER;
...
INSERT INTO LOCACAO VALUES(NEXTVAL('SEQ_LOCACAO'),NOW(),50,11,400);
...
SELECT NOME, CARGO,
CASE
	WHEN CARGO = 'Financial Advisor' THEN 'cargo one'
	WHEN CARGO = 'Structural Engineer' THEN 'cargo two'
	WHEN CARGO = 'Executive Secretery' THEN 'cargo three'
	ELSE 'Sem cargo'
END AS "CONDIÇÕES"
FROM FUNCIONARIOS;
...
/* FILTROS BASEADOS EM MULTIPLOS TIPOS E COLUNAS - CONSIDERANDO OR E AND */
...
/* FILTROS BAEADOS EM ÚNICO TIPO E COLUNA - ATENÇÃO PARA A REGRA DO AND E OR - 
Em relacionamento 1 x 1 o filtro AND tratando de uma única coluna sempre dará falso*/
...
/* E SE EU QUISESSE FILTRAR AGRUPAMENTO PELO SALÁRIO ? EX.: MAIOR QUE 4.000.000 */
...
SELECT NOME, CARGO,
CASE
	WHEN CARGO LIKE '%Assistant%' THEN 'ASSISTENTE'
	ELSE 'NÃO ASSISTENTE'
END AS "ASSISTENTE OU NÃO"
FROM FUNCIONARIOS;
